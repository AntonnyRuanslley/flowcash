...
class TransactionsListPageCopy extends StatefulWidget {
  const TransactionsListPageCopy({Key? key}) : super(key: key);

  @override
  State<TransactionsListPageCopy> createState() => _TransactionsListPageCopyState();
}

class _TransactionsListPageCopyState extends State<TransactionsListPageCopy> {
